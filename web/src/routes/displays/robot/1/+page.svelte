...
<div
	class="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-900/30 via-slate-900 to-blue-900/30 p-8"
>
	<div class="w-full max-w-4xl text-center">
		<!-- Robot Header -->
		<div class="card mb-8 border-blue-500/30 bg-gradient-to-r from-blue-600/20 to-cyan-600/20">
